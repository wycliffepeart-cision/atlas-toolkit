...
_InputCheckbox_handleInputChange = new WeakMap(), _InputCheckbox_instances = new WeakSet(), _InputCheckbox_attributePassthrought = function _InputCheckbox_attributePassthrought(name, value, exclude = []) {
