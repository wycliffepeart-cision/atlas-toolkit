...
_InputText_handleInputChange = new WeakMap();
_InputText_handleInputInvalid = new WeakMap();
_InputText_instances = new WeakSet();
_InputText_attributePassthrought = function _InputText_attributePassthrought(name, value, exclude = []) {
